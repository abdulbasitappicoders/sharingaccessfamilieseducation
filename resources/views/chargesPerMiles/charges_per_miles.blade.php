...
@endif
    ...
    @csrf
        ...
        <div class="mb-3">
            ...
            <input type="text" value="{{$charge->charges_per_mile}}" class="form-control" name="charges_per_mile" id="exampleInputUsername1" autocomplete="off" placeholder="Charges Per Mile">
        </div>
