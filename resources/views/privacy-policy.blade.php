        ...
        <section class="section mt-0 ">
            <div class="container">
                <div class="appie-hero-content">
                            <h2 class="mt-3">Collecting and Using Your Personal Data</h2>
                            <h3 class="mt-3">Types of Data Collected</h3>
                            <h4 class="mt-3">Personal Data</h4>
                            <p class="text-muted mt-3">While using Our Service, We may ask You to provide Us with certain personally identifiable information that can be used to contact or identify You. Personally identifiable information may include, but is not limited to:
                        </p>
                        ...
                        <p class="mt-3">Usage Data is collected automatically when using the Service.
...
<h4 class="mt-3">Information from Third-Party Social Media Services</h4>
                        <p class="mt-3">The Company allows You to create an account and log in to use the Service through the following Third-party Social Media Services:
</p>
...
<h4 class="mt-3">Information Collected while Using the Application</h4>
<p class="mt-3">
    While using Our Application, in order to provide features of Our Application, We may collect, with Your prior permission:
Information regarding your location<br>
Pictures and other information from your Device's camera and photo library <br>
...
<h4 class="mt-3">Use of Your Personal Data</h4>
<p class="mt-3">
...
<h3 class="mt-3">Disclosure of Your Personal Data</h3>
...
<h4 class="mt-3">Security of Your Personal Data</h4>
...
<h2 class="mt-3">Links to Other Websites</h2>
<p>
...
<p class="mt-3">If you have any questions about this Privacy Policy, You can contact us:<br>
By email: <a href="mailto:support@safe.com">support@safe.com</a>
</p>
